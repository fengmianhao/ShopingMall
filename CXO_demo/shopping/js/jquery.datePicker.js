 ...
 **/
		renderCalendar  :   function(s)
		{
			...
			//s.showHeader == $.dpConst.SHOW_HEADER_SHORT ? day.substr(0, 1) : day)
			...
			var firstDayOffset = Date.firstDayOfWeek - currentDate.getDay() -6;
			if (firstDayOffset > 1) firstDayOffset -= 7;
			var weeksToDraw = Math.ceil(( (-1*firstDayOffset+1) + currentDate.getDaysInMonth() ) /7);
			currentDate.addDays(firstDayOffset+5);
